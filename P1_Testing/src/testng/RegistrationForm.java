...
public class RegistrationForm 
{
	...
	RegistrationForm (String t, String fN, String lN, String uN, String e, String bd, 
...
//		insertEducationalStage();
		 ...
		 * the constructor here, but rather be taken in the main class and then the
		 * parameters be sent to the constructor here.*/
		type = t;
		firstName = fN;
		lastName = lN;
		email = e;
