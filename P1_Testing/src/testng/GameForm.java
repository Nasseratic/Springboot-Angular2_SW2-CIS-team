...
public class GameForm 
{
	...
	GameForm(String n, String t, String h){
...
//		insertHelp();
	...
	/*----- ABEER -----*/ //???
	/* Why I modified this? Because the input shouldn't be taken from the user in 
	 * the constructor here.But I don't have any idea why GameForm has the duplicates 
	...
	/*----- ABEER -----*/
	/* Same thing but just made it return array of questions so it can be used in 
	 * the constructor of GameForm. */
	ArrayList <Question> insertQuestions ()
	{
